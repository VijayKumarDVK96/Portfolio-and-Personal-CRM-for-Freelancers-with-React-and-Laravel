    ...
    <div class="row">
        <div class="col-md-12">
            <form id="create_estimate">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="cal-icon"><input class="form-control date estimate_date" name="estimate_date" type="text"></div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="cal-icon"><input class="form-control date expiry_date" name="expiry_date" type="text"></div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="other_information" class="form-control" rows="4"></textarea>
                ...
                <button id="add_estimate" class="btn btn-info">
...
@section('scripts')
    ...
    <script>
        ...
        $("#add_estimate").click(function(e) {
            e.preventDefault();
            $("#add_estimate").attr('disabled', true);
            $("#add_estimate .spinner-border").css('display', 'inline-block');
            $(".error-message").hide();
            $(".success-message").hide();

            var request = $("#create_estimate").serializeArray();

            $.ajax({
                url: base_url+"/admin/create-estimate",
                method: 'post',
                data: request,
                dataType: "json",
                error: function(data) {
                ...
                success: function(data) {
                    if (data.status == "success") {
                        ...
                        $("#create_estimate").trigger("reset");
                    }
                },
                complete: function() {
                    $("#add_estimate").attr('disabled', false);
                    $("#add_estimate .spinner-border").css('display', 'none');
                }
            });
        });
