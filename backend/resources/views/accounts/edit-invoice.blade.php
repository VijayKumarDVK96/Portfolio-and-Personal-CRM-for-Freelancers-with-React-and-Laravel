                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="project_name"> 
                                ...
                                @foreach ($projects as $value)
                                    @if($value->id == $invoice->project_id)
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="cal-icon"><input class="form-control date invoice_date" name="invoice_date" type="text" value="{{$invoice->invoice_date}}"></div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="cal-icon"><input class="form-control date due_date" name="due_date" type="text" value="{{$invoice->due_date}}"></div>
                            ...
                            <table class="table table-hover table-white items">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if(count($invoice->invoice_items)-1 == $key)
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" name="other_information">{{$invoice->description}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <button id="edit_invoice" class="btn btn-info">
...
@section('scripts')
    ...
    <script>
        ...
        $("#edit_invoice").click(function(e) {
            e.preventDefault();
            $("#edit_invoice").attr('disabled', true);
            $("#edit_invoice .spinner-border").css('display', 'inline-block');
            $(".error-message").hide();
            $(".success-message").hide();

            var request = $("#update_invoice").serializeArray();
            var id = '{{$id}}';

            $.ajax({
                url: base_url+"/admin/update-invoice/"+id,
                method: 'post',
                data: request,
                dataType: "json",
                error: function(data) {
                ...
                complete: function() {
                    $("#edit_invoice").attr('disabled', false);
                    $("#edit_invoice .spinner-border").css('display', 'none');
                }
            });
        });
