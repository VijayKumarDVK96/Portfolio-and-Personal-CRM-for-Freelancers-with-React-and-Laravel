    ...
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <a class="btn btn-primary btn-lg pull-right" href="{{url('admin/add-invoice')}}">Add New Invoice</a>
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script>
        ...
        function readInvoice() {
            ...
            $.ajax({
                url: base_url+'/admin/invoices-ajax',
                method: "post",
                dataType: 'json',
        ...
        function deleteInvoice(id) {
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        url: base_url+'/admin/delete-invoice/'+id,
                        dataType: 'json',
