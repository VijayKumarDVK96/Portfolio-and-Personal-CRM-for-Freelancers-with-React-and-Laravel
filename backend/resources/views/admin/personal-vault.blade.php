...
<script>
    ...
    function readVault(pageno='') {
        ...
        var link = base_url+"/admin/read-personal-vault-ajax/"+pageno;
    ...
    function editVault(id) {
        ...
        $.ajax({
            url: base_url+'/admin/edit-personal-vault/'+id,
            dataType: 'json',
            success: function(obj) {
                ...
                $('#edit_notes').summernote('code', obj.data.notes)
            }
        });
    }
    ...
    function deleteCredentials(id) {
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    url: base_url+'/admin/delete-personal-vault/'+id,
                    dataType: 'json',
    ...
    $("#add_vault").click(function(e) {
        ...
        $.ajax({
            url: base_url+"/admin/add-new-personal-vault",
            method: 'post',
            data: request,
            error: function(data) {
                $(".error-message").show();
    ...
    $("#edit_vault").click(function(e) {
        ...
        $.ajax({
            url: base_url+"/admin/update-personal-vault/"+vault_id,
            method: 'post',
            data: request,
            error: function(data) {
                $(".error-message").show();
